...
check_PROGRAMS = bin/generate_sequence$(EXEEXT) \
	...
	bin/test_read_parser$(EXEEXT) \
	bin/test_offsets_key_value$(EXEEXT)
...
am_bin_jellyfish_OBJECTS = jellyfish/jellyfish.$(OBJEXT) \
	...
	jellyfish/floats.$(OBJEXT) jellyfish/uniqueness_main.$(OBJEXT) \
	jellyfish/allocators_mmap.$(OBJEXT) jellyfish/yaggo.$(OBJEXT)
...
am_bin_test_offsets_key_value_OBJECTS = unit_tests/bin_test_offsets_key_value-test_offsets_key_value.$(OBJEXT)
bin_test_offsets_key_value_OBJECTS =  \
	$(am_bin_test_offsets_key_value_OBJECTS)
bin_test_offsets_key_value_DEPENDENCIES = libgtest_main.la
bin_test_offsets_key_value_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CXX \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CXXLD) \
	$(bin_test_offsets_key_value_CXXFLAGS) $(CXXFLAGS) \
...
SOURCES = $(libgtest_la_SOURCES) $(libgtest_main_la_SOURCES) \
	...
	$(bin_jellyfish_SOURCES) $(bin_test_double_fifo_input_SOURCES) \
	$(bin_test_offsets_key_value_SOURCES) \
...
ACLOCAL = ${SHELL} /cluster/home/jstjohn/src/jsj_Jellyfish/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /cluster/home/jstjohn/src/jsj_Jellyfish/missing --run autoconf
AUTOHEADER = ${SHELL} /cluster/home/jstjohn/src/jsj_Jellyfish/missing --run autoheader
AUTOMAKE = ${SHELL} /cluster/home/jstjohn/src/jsj_Jellyfish/missing --run automake-1.11
AWK = gawk
CC = gcc44
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /cluster/home/jstjohn/src/jsj_Jellyfish/missing --run makeinfo
MD5 = md5sum
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_STRING = jellyfish 1.1.4
...
STRIP = strip
VERSION = 1.1.4
abs_builddir = /cluster/home/jstjohn/src/jsj_Jellyfish
abs_srcdir = /cluster/home/jstjohn/src/jsj_Jellyfish
abs_top_builddir = /cluster/home/jstjohn/src/jsj_Jellyfish
abs_top_srcdir = /cluster/home/jstjohn/src/jsj_Jellyfish
ac_ct_CC = gcc44
ac_ct_CXX = 
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /cluster/home/jstjohn/src/jsj_Jellyfish/install-sh
...
pdfdir = ${docdir}
prefix = /cluster/home/jstjohn
program_transform_name = s&^&jsj_&
psdir = ${docdir}
...
EXTRA_DIST = m4/gnulib-cache.m4 doc/jellyfish.pdf doc/jellyfish.man \
	README LICENSE HalfLICENSE jellyfish/cite_cmdline.hpp \
...
library_includedir = $(includedir)/jellyfish-1.1.4/jellyfish
...
TESTS = tests/generate_sequence.sh tests/serial_hashing.sh \
	...
	tests/big.sh tests/parsers.sh unit_tests/unit_tests.sh
...
jellyfish/libjellyfish_la-allocators_mmap.lo:  \
	jellyfish/$(am__dirstamp) jellyfish/$(DEPDIR)/$(am__dirstamp)
libjellyfish.la: $(libjellyfish_la_OBJECTS) $(libjellyfish_la_DEPENDENCIES) $(EXTRA_libjellyfish_la_DEPENDENCIES) 
...
jellyfish/floats.$(OBJEXT): jellyfish/$(am__dirstamp) \
	jellyfish/$(DEPDIR)/$(am__dirstamp)
jellyfish/uniqueness_main.$(OBJEXT): jellyfish/$(am__dirstamp) \
	jellyfish/$(DEPDIR)/$(am__dirstamp)
...
unit_tests/$(DEPDIR)/$(am__dirstamp):
	...
	@: > unit_tests/$(DEPDIR)/$(am__dirstamp)
unit_tests/bin_test_offsets_key_value-test_offsets_key_value.$(OBJEXT):  \
	unit_tests/$(am__dirstamp) \
	unit_tests/$(DEPDIR)/$(am__dirstamp)
bin/test_offsets_key_value$(EXEEXT): $(bin_test_offsets_key_value_OBJECTS) $(bin_test_offsets_key_value_DEPENDENCIES) $(EXTRA_bin_test_offsets_key_value_DEPENDENCIES) bin/$(am__dirstamp)
	@rm -f bin/test_offsets_key_value$(EXEEXT)
	$(AM_V_CXXLD)$(bin_test_offsets_key_value_LINK) $(bin_test_offsets_key_value_OBJECTS) $(bin_test_offsets_key_value_LDADD) $(LIBS)
...
mostlyclean-compile:
	...
	-rm -f jellyfish/uniqueness_main.$(OBJEXT)
	-rm -f jellyfish/yaggo.$(OBJEXT)
	-rm -f unit_tests/bin_test_offsets_key_value-test_offsets_key_value.$(OBJEXT)
...
include jellyfish/$(DEPDIR)/allocators_mmap.Po
include jellyfish/$(DEPDIR)/backtrace.Po
include jellyfish/$(DEPDIR)/cite.Po
include jellyfish/$(DEPDIR)/dbg.Po
include jellyfish/$(DEPDIR)/dump_fastq_main.Po
include jellyfish/$(DEPDIR)/dump_main.Po
include jellyfish/$(DEPDIR)/err.Po
include jellyfish/$(DEPDIR)/file_parser.Po
include jellyfish/$(DEPDIR)/floats.Po
include jellyfish/$(DEPDIR)/generate_sequence.Po
include jellyfish/$(DEPDIR)/half.Po
include jellyfish/$(DEPDIR)/hash_fastq_merge.Po
include jellyfish/$(DEPDIR)/hash_merge.Po
include jellyfish/$(DEPDIR)/histo_fastq_main.Po
include jellyfish/$(DEPDIR)/histo_main.Po
include jellyfish/$(DEPDIR)/jellyfish.Po
include jellyfish/$(DEPDIR)/libjellyfish_la-allocators_mmap.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-backtrace.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-dbg.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-err.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-file_parser.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-floats.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-half.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-mapped_file.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-misc.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-parse_dna.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-parse_quake.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-parse_qual_dna.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-parse_read.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-read_parser.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-seq_qual_parser.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-sequence_parser.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-square_binary_matrix.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-storage.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-thread_exec.Plo
include jellyfish/$(DEPDIR)/libjellyfish_la-time.Plo
include jellyfish/$(DEPDIR)/mapped_file.Po
include jellyfish/$(DEPDIR)/mer_counter.Po
include jellyfish/$(DEPDIR)/mersenne.Po
include jellyfish/$(DEPDIR)/misc.Po
include jellyfish/$(DEPDIR)/parse_dna.Po
include jellyfish/$(DEPDIR)/parse_quake.Po
include jellyfish/$(DEPDIR)/parse_qual_dna.Po
include jellyfish/$(DEPDIR)/parse_read.Po
include jellyfish/$(DEPDIR)/query_main.Po
include jellyfish/$(DEPDIR)/read_parser.Po
include jellyfish/$(DEPDIR)/seq_qual_parser.Po
include jellyfish/$(DEPDIR)/sequence_parser.Po
include jellyfish/$(DEPDIR)/square_binary_matrix.Po
include jellyfish/$(DEPDIR)/stats_main.Po
include jellyfish/$(DEPDIR)/storage.Po
include jellyfish/$(DEPDIR)/test_double_fifo_input.Po
include jellyfish/$(DEPDIR)/test_read_parser.Po
include jellyfish/$(DEPDIR)/thread_exec.Po
include jellyfish/$(DEPDIR)/time.Po
include jellyfish/$(DEPDIR)/uniqueness_main.Po
include jellyfish/$(DEPDIR)/yaggo.Po
include unit_tests/$(DEPDIR)/bin_test_offsets_key_value-test_offsets_key_value.Po
...
jellyfish/libjellyfish_la-square_binary_matrix.lo: jellyfish/square_binary_matrix.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-square_binary_matrix.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-square_binary_matrix.Plo
#	$(AM_V_CXX)source='jellyfish/square_binary_matrix.cc' object='jellyfish/libjellyfish_la-square_binary_matrix.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
...
jellyfish/libjellyfish_la-err.lo: jellyfish/err.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-err.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-err.Plo
#	$(AM_V_CXX)source='jellyfish/err.cc' object='jellyfish/libjellyfish_la-err.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-err.lo `test -f 'jellyfish/err.cc' || echo '$(srcdir)/'`jellyfish/err.cc
...
jellyfish/libjellyfish_la-misc.lo: jellyfish/misc.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-misc.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-misc.Plo
#	$(AM_V_CXX)source='jellyfish/misc.cc' object='jellyfish/libjellyfish_la-misc.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-misc.lo `test -f 'jellyfish/misc.cc' || echo '$(srcdir)/'`jellyfish/misc.cc
...
jellyfish/libjellyfish_la-storage.lo: jellyfish/storage.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-storage.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-storage.Plo
#	$(AM_V_CXX)source='jellyfish/storage.cc' object='jellyfish/libjellyfish_la-storage.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-storage.lo `test -f 'jellyfish/storage.cc' || echo '$(srcdir)/'`jellyfish/storage.cc
...
jellyfish/libjellyfish_la-thread_exec.lo: jellyfish/thread_exec.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-thread_exec.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-thread_exec.Plo
#	$(AM_V_CXX)source='jellyfish/thread_exec.cc' object='jellyfish/libjellyfish_la-thread_exec.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-thread_exec.lo `test -f 'jellyfish/thread_exec.cc' || echo '$(srcdir)/'`jellyfish/thread_exec.cc
...
jellyfish/libjellyfish_la-time.lo: jellyfish/time.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-time.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-time.Plo
#	$(AM_V_CXX)source='jellyfish/time.cc' object='jellyfish/libjellyfish_la-time.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-time.lo `test -f 'jellyfish/time.cc' || echo '$(srcdir)/'`jellyfish/time.cc
...
jellyfish/libjellyfish_la-file_parser.lo: jellyfish/file_parser.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-file_parser.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-file_parser.Plo
#	$(AM_V_CXX)source='jellyfish/file_parser.cc' object='jellyfish/libjellyfish_la-file_parser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-file_parser.lo `test -f 'jellyfish/file_parser.cc' || echo '$(srcdir)/'`jellyfish/file_parser.cc
...
jellyfish/libjellyfish_la-read_parser.lo: jellyfish/read_parser.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-read_parser.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-read_parser.Plo
#	$(AM_V_CXX)source='jellyfish/read_parser.cc' object='jellyfish/libjellyfish_la-read_parser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-read_parser.lo `test -f 'jellyfish/read_parser.cc' || echo '$(srcdir)/'`jellyfish/read_parser.cc
...
jellyfish/libjellyfish_la-parse_read.lo: jellyfish/parse_read.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-parse_read.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-parse_read.Plo
#	$(AM_V_CXX)source='jellyfish/parse_read.cc' object='jellyfish/libjellyfish_la-parse_read.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-parse_read.lo `test -f 'jellyfish/parse_read.cc' || echo '$(srcdir)/'`jellyfish/parse_read.cc
...
jellyfish/libjellyfish_la-half.lo: jellyfish/half.cpp
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-half.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-half.Plo
#	$(AM_V_CXX)source='jellyfish/half.cpp' object='jellyfish/libjellyfish_la-half.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-half.lo `test -f 'jellyfish/half.cpp' || echo '$(srcdir)/'`jellyfish/half.cpp
...
jellyfish/libjellyfish_la-mapped_file.lo: jellyfish/mapped_file.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-mapped_file.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-mapped_file.Plo
#	$(AM_V_CXX)source='jellyfish/mapped_file.cc' object='jellyfish/libjellyfish_la-mapped_file.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-mapped_file.lo `test -f 'jellyfish/mapped_file.cc' || echo '$(srcdir)/'`jellyfish/mapped_file.cc
...
jellyfish/libjellyfish_la-parse_dna.lo: jellyfish/parse_dna.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-parse_dna.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-parse_dna.Plo
#	$(AM_V_CXX)source='jellyfish/parse_dna.cc' object='jellyfish/libjellyfish_la-parse_dna.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-parse_dna.lo `test -f 'jellyfish/parse_dna.cc' || echo '$(srcdir)/'`jellyfish/parse_dna.cc
...
jellyfish/libjellyfish_la-parse_quake.lo: jellyfish/parse_quake.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-parse_quake.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-parse_quake.Plo
#	$(AM_V_CXX)source='jellyfish/parse_quake.cc' object='jellyfish/libjellyfish_la-parse_quake.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-parse_quake.lo `test -f 'jellyfish/parse_quake.cc' || echo '$(srcdir)/'`jellyfish/parse_quake.cc
...
jellyfish/libjellyfish_la-parse_qual_dna.lo: jellyfish/parse_qual_dna.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-parse_qual_dna.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-parse_qual_dna.Plo
#	$(AM_V_CXX)source='jellyfish/parse_qual_dna.cc' object='jellyfish/libjellyfish_la-parse_qual_dna.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-parse_qual_dna.lo `test -f 'jellyfish/parse_qual_dna.cc' || echo '$(srcdir)/'`jellyfish/parse_qual_dna.cc
...
jellyfish/libjellyfish_la-sequence_parser.lo: jellyfish/sequence_parser.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-sequence_parser.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-sequence_parser.Plo
#	$(AM_V_CXX)source='jellyfish/sequence_parser.cc' object='jellyfish/libjellyfish_la-sequence_parser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-sequence_parser.lo `test -f 'jellyfish/sequence_parser.cc' || echo '$(srcdir)/'`jellyfish/sequence_parser.cc
...
jellyfish/libjellyfish_la-seq_qual_parser.lo: jellyfish/seq_qual_parser.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-seq_qual_parser.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-seq_qual_parser.Plo
#	$(AM_V_CXX)source='jellyfish/seq_qual_parser.cc' object='jellyfish/libjellyfish_la-seq_qual_parser.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-seq_qual_parser.lo `test -f 'jellyfish/seq_qual_parser.cc' || echo '$(srcdir)/'`jellyfish/seq_qual_parser.cc
...
jellyfish/libjellyfish_la-backtrace.lo: jellyfish/backtrace.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-backtrace.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-backtrace.Plo
#	$(AM_V_CXX)source='jellyfish/backtrace.cc' object='jellyfish/libjellyfish_la-backtrace.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-backtrace.lo `test -f 'jellyfish/backtrace.cc' || echo '$(srcdir)/'`jellyfish/backtrace.cc
...
jellyfish/libjellyfish_la-floats.lo: jellyfish/floats.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-floats.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-floats.Plo
#	$(AM_V_CXX)source='jellyfish/floats.cc' object='jellyfish/libjellyfish_la-floats.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-floats.lo `test -f 'jellyfish/floats.cc' || echo '$(srcdir)/'`jellyfish/floats.cc
...
jellyfish/libjellyfish_la-dbg.lo: jellyfish/dbg.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-dbg.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-dbg.Plo
#	$(AM_V_CXX)source='jellyfish/dbg.cc' object='jellyfish/libjellyfish_la-dbg.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-dbg.lo `test -f 'jellyfish/dbg.cc' || echo '$(srcdir)/'`jellyfish/dbg.cc
...
jellyfish/libjellyfish_la-allocators_mmap.lo: jellyfish/allocators_mmap.cc
	...
	$(AM_V_at)$(am__mv) jellyfish/$(DEPDIR)/libjellyfish_la-allocators_mmap.Tpo jellyfish/$(DEPDIR)/libjellyfish_la-allocators_mmap.Plo
#	$(AM_V_CXX)source='jellyfish/allocators_mmap.cc' object='jellyfish/libjellyfish_la-allocators_mmap.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libjellyfish_la_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o jellyfish/libjellyfish_la-allocators_mmap.lo `test -f 'jellyfish/allocators_mmap.cc' || echo '$(srcdir)/'`jellyfish/allocators_mmap.cc

unit_tests/bin_test_offsets_key_value-test_offsets_key_value.o: unit_tests/test_offsets_key_value.cc
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bin_test_offsets_key_value_CXXFLAGS) $(CXXFLAGS) -MT unit_tests/bin_test_offsets_key_value-test_offsets_key_value.o -MD -MP -MF unit_tests/$(DEPDIR)/bin_test_offsets_key_value-test_offsets_key_value.Tpo -c -o unit_tests/bin_test_offsets_key_value-test_offsets_key_value.o `test -f 'unit_tests/test_offsets_key_value.cc' || echo '$(srcdir)/'`unit_tests/test_offsets_key_value.cc
	$(AM_V_at)$(am__mv) unit_tests/$(DEPDIR)/bin_test_offsets_key_value-test_offsets_key_value.Tpo unit_tests/$(DEPDIR)/bin_test_offsets_key_value-test_offsets_key_value.Po
#	$(AM_V_CXX)source='unit_tests/test_offsets_key_value.cc' object='unit_tests/bin_test_offsets_key_value-test_offsets_key_value.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bin_test_offsets_key_value_CXXFLAGS) $(CXXFLAGS) -c -o unit_tests/bin_test_offsets_key_value-test_offsets_key_value.o `test -f 'unit_tests/test_offsets_key_value.cc' || echo '$(srcdir)/'`unit_tests/test_offsets_key_value.cc

unit_tests/bin_test_offsets_key_value-test_offsets_key_value.obj: unit_tests/test_offsets_key_value.cc
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bin_test_offsets_key_value_CXXFLAGS) $(CXXFLAGS) -MT unit_tests/bin_test_offsets_key_value-test_offsets_key_value.obj -MD -MP -MF unit_tests/$(DEPDIR)/bin_test_offsets_key_value-test_offsets_key_value.Tpo -c -o unit_tests/bin_test_offsets_key_value-test_offsets_key_value.obj `if test -f 'unit_tests/test_offsets_key_value.cc'; then $(CYGPATH_W) 'unit_tests/test_offsets_key_value.cc'; else $(CYGPATH_W) '$(srcdir)/unit_tests/test_offsets_key_value.cc'; fi`
	$(AM_V_at)$(am__mv) unit_tests/$(DEPDIR)/bin_test_offsets_key_value-test_offsets_key_value.Tpo unit_tests/$(DEPDIR)/bin_test_offsets_key_value-test_offsets_key_value.Po
#	$(AM_V_CXX)source='unit_tests/test_offsets_key_value.cc' object='unit_tests/bin_test_offsets_key_value-test_offsets_key_value.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(bin_test_offsets_key_value_CXXFLAGS) $(CXXFLAGS) -c -o unit_tests/bin_test_offsets_key_value-test_offsets_key_value.obj `if test -f 'unit_tests/test_offsets_key_value.cc'; then $(CYGPATH_W) 'unit_tests/test_offsets_key_value.cc'; else $(CYGPATH_W) '$(srcdir)/unit_tests/test_offsets_key_value.cc'; fi`
